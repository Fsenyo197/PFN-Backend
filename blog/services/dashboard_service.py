...
class DashboardService:
    ...
    def get_total_written_articles(self) -> List[Article]:
        return self.repository.get_total_written_articles()

    def get_total_published_articles(self) -> List[Article]:
        return self.repository.get_total_published_articles()

    def get_total_drafted_articles(self) -> List[Article]:
        return self.repository.get_total_drafted_articles()

    def get_total_deleted_articles(self) -> List[Article]:
        return self.repository.get_total_deleted_articles()
